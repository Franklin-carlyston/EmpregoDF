...
<html lang="pt-br">
  <head>
    ...
    <meta name="viewport" content="width=device-width, user-scalable=no, inicial-scale=1.0, maximum-scale=1.0, menimum-scale=1.0">
  ...
  <body>
				...
				<div class="col-sm-2 wrap">	
					<div class="widger">
						<div class="fecha">	
							...
							<p id="dia" class="dia">29</p>														<p>
							<p>de</p>
							<p id="mes" class="mes">outubro</p>
							<p>de</p>
						...
						<div class="reloj">
							...
							<p>:</p>
							<p id="minutos" class="minutos">44</p>
							<p>:</p>
	...
	<script src="assets/reloj.js"></script>
